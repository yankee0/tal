    ...
    <form action="<?= base_url(session()->root . '/livraisons/ajout') ?>" method="post" class="row">
      <div class="col-md">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="armateur" id="armateur" aria-describedby="helpId" placeholder="">
        </div>
      </div>
      <div class="col-md">
        <div class="mb-3">
          <label for="type_tc" class="form-label">Type TC</label>
          <input type="text" class="form-control" name="type_tc" id="type_tc" aria-describedby="helpId" placeholder="">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="mvt_aller" id="mvt_aller" aria-describedby="helpId" placeholder="">
        </div>
        <div class="mb-3">
          <label for="adresse" class="form-label">Adresse</label>
          <input type="text" class="form-control" name="adresse" id="adresse" aria-describedby="helpId" placeholder="">
        </div>
      ...
      <div class="col-md">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="zone" id="zone" aria-describedby="helpId" placeholder="">
        </div>
        <div class="mb-3">
          <label for="client" class="form-label">Client</label>
          <input type="text" class="form-control" name="client" id="client" aria-describedby="helpId" placeholder="">
        </div>
        ...
        <div class="retour" style="display: none">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="mvt_retour" id="mvt_retour" aria-describedby="helpId" placeholder="">
          </div>
        </div>
