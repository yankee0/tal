    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <?php if ($root == '/super-admin' or $root == '/admin') : ?>
        ...
        <li class="nav-item <?= (session()->has('position') and session()->position == 'utilisateurs') ? 'active' : '' ?>">
          <a class="nav-link collapsed" href="<?= base_url($root . '/utilisateurs') ?>" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="buttons.html">Liste des utilisateurs</a>
              <a class="collapse-item" href="cards.html">Nouveau compte</a>
            </div>
          </div>
        </li>
